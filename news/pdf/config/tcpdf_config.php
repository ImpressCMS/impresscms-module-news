...
if (!defined("K_TCPDF_EXTERNAL_CONFIG")) {
	 ...
	 * installation path
	 */
	define ("K_PATH_MAIN", XOOPS_ROOT_PATH.'/modules/news/pdf/');

	/**
	 * url path
	 */
	define ("K_PATH_URL", XOOPS_URL.'/modules/news/pdf/');
	 ...
	 * document creator
	 */
	define ("PDF_CREATOR", "XOOPS");

	/**
	 * document author
	 */
	define ("PDF_AUTHOR", "XOOPS");

	/**
	 * header title
	 */
	define ("PDF_HEADER_TITLE", "News");
