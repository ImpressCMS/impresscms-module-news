...
define('_MI_NEWS_ADMENU3','Enviar/Editar artículos');
...
define('_MI_NEWS_AUTHOR_EDIT','Permitir a los redactores editar sus envíos');
define('_MI_NEWS_AUTHOR_EDIT_DESC','Mediante esta opción, se autoriza a los redactores para que puedan editar sus propios artículos.');
...
define('_MI_NEWS_META_DATA_DESC', "Si es activada esta opción, lso usuarios con permisos para enviar artículos podrán incluir datos en la etiqueta Meta, estos son: metakeywords y metadescription");
...
define("_MI_NEWS_INFOTIPS_DES","Si es activada esta opción, los enlaces relativos a los artículos mostrarán, al poner el ratón encima, los primeros n caracteres del artículo en una viñeta. Si pone 0 como valor, las viñetas de información no mostrarán nada.");
...
define("_MI_NEWS_TABS_SKIN","Selecione el aspecto de las pestañas");
...
define("_MI_NEWS_FF_MICROFORMAT_DSC","Para más información, visiste <a href='http://wiki.mozilla.org/Microsummaries' target='_blank'>esta página</a>");
